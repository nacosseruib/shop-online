...
@section("pageTitle", "MY CHECKEDOUT ORDER DETAILS")
@section('pageContent')

@if( isset($itemInCart) && (count($itemInCart) > 0) )
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div align="center">
                ...
                <table class="table table-bordered table-condensed table-hover table-responsive bg-light">
                    <thead>
                        <tr>
                            <th colspan="8"><b>LIST OF ALL MY CHECKEDOUT ORDERS </b></th>
                        </tr>
                        <tr>
                            <th>SN</th>
                            <th>ITEM</th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white p-2">
                            <td colspan="5"></td>
                            <td>{{ isset($itemQuantity) ? $itemQuantity : 0 }} item(s)</td>
                            <td>
            ...
            <div class="row d-print-none">
                <div align="center" class="mb-4 col-md-12">
                    <a href="{{ (Route::has('checkoutOrder') ? Route('checkoutOrder') : 'javascript:;' ) }}" class="btn btn-outline-info btn-lg">
                        Go Back
                    </a>
                </div>
            </div>
