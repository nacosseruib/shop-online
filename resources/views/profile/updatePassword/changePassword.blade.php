...
@section("pageTitle", "Update Account - Change Password")
...
@section('pageContent')
    ...
    @section('pageSubContent')
        @includeIf('profile.updatePassword.changePasswordView', ['showPageUpdateAccount' => (isset($showPageUpdateAccount) ? $showPageUpdateAccount : 1)])
    @endsection
