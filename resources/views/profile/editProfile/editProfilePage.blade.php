...
@section("pageTitle")
    Edit {{ (isset($userFullName)  ? $userFullName : null) }}'s profile
@endsection
...
@section('pageContent')
    ...
    @section('pageSubContent')
        @includeIf('profile.editProfile.editProfilePageView', ['showPageProfile' => (isset($showPageProfile) ? $showPageProfile : 1)])
    @endsection
