                ...
                @if(isset($getMyDelivery) && $getMyDelivery)
                    @foreach($getMyDelivery as $key => $value)
                        <tr class="text-center font-weight-bold">
                            ...
                            <td>
                                <a href="{{ Route::has('detailsItemIHaveDelivery') ? Route('detailsItemIHaveDelivery', ['u'=>$value->receiverID, 'on'=> $value->receiver_order_number]) : 'javascript:;' }}" class="btn btn-info">View</a>
                            </td>
                        </tr>
