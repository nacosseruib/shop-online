        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div align="center">
                ...
                <table class="table table-bordered table-condensed table-hover table-responsive bg-light">
                    <thead>
                        <tr>
                            <th colspan="8"><b>LIST OF ITEMS I HAVE DELIVERED TO {{ isset($setUserFullName) ? strtoupper($setUserFullName) : ''}} </b></th>
                        </tr>
                        <tr>
                            <th>SN</th>
                            <th>ITEM</th>
            ...
            <div class="row d-print-none">
                <div align="center" class="mb-4 col-md-12">
                    <a href="{{ (Route::has('myItemDelivery') ? Route('myItemDelivery') : 'javascript:;' ) }}" class="btn btn-outline-info btn-lg">
                        Go Back
                    </a>
                </div>
            </div>
