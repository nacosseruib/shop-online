...
@section("pageTitle", "All Items I Have Delivered")
...
@section('pageContent')
    ...
    @section('pageSubContent')
        @includeIf('myItemDelivery.myDeliveryPageView', ['showPageMyDelivery' => (isset($showPageMyDelivery) ? $showPageMyDelivery : 1)])
    @endsection
