...
@if(isset($showMatchPage) && $showMatchPage ==1 && (isset($getSellerStoreDetails) && (count($getSellerStoreDetails) > 0) && (isset($getReceiverDetails) && $getReceiverDetails) ))
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
            <div align="center">
                ...
                <div class="alert alert-warning h4 MT-2">
                    You are to buy all the items below and deliver to the delivery address below<br />
                    <em class="text-info">NOTE: On delivery, get the <b>DELIVERY CODE</b> from the user to confirm you have successfully delivered to the user. Then, login to your account and confirm your delivery items. </em>
                </div>
                <div class="row bg-light text-info m-3 p-2 h5">
                    <div class="col-md-4" style="border-right: #e3e3e3 2px solid;">
                        <div class="col-md-12 text-center">CHECKOUT PRICE</div>
                        <div class="col-md-12 text-center"><b><span class=money>${{ (isset($totalCartAmount) ? number_format($totalCartAmount, 2) : 0.00) }}</span></b></div>
                    </div>
                    <div class="col-md-4">
                        <div class="col-md-12 text-center">DISCOUNTED PRICE</div>
                        <div class="col-md-12 text-center"><b><span class=money>${{ (isset($userDiscountedTotalCartAmount) ? number_format($userDiscountedTotalCartAmount, 2) : 0.00) }}</span></b></div>
                    </div>
                    <div class="col-md-4" style="border-left: #e3e3e3 2px solid;">
                        <div class="col-md-12 text-center">DISCOUNT RATE</div>
                        <div class="col-md-12 text-center">
                            <b>
                             {{ isset($percentageFrom) && isset($percentageTo) ? '('.$percentageFrom .' - '. $percentageTo.')%' : ' - ' }}
                            </b>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center m-4">
                        <a href="{{ Route::has('listDeliveryAgent') ? Route('listDeliveryAgent') : 'javascript:;' }}" class="btn btn-outline-success">Click here to use any of our delivery agents</a>
                    </div>
                </div><!--//row-->
            ...
            <div class="row">
                <div align="center" class="mb-4 col-md-12">
                    <a href="{{ (Route::has('pendingItemNeedToDeliver') ? Route('pendingItemNeedToDeliver') : 'javascript:;' ) }}" class="btn btn-outline-info btn-lg">
                        Go Back
                    </a>
                    <a href="javascript:;" class="btn btn-outline-danger btn-lg" data-toggle="modal" data-backdrop="false" data-target="#continueCancelOrder">
                        Cancel this order
                    </a>
                </div>
            </div>
    ...
    <div id="shopify-section-cart-template" class="shopify-section">
        <div class="container page-cart" data-section-id="cart-template" data-section-type="cart-template">
            <div class="empty-page-content text-center">
                ...
                <div>
                   It seems some thing could be wrong with this order! Perhaps the order has been cancelled.
                </div>
                {{-- <a href="{{ (Route::has('matchUser') ? Route('matchUser', ['on'=>(isset($getOrderNumber) ? $getOrderNumber : '')]) : 'javascript:;') }}" class="btn btn--has-icon-after cart__continue-btn sn"><i class="fa fa-refresh" aria-hidden="true"></i> Click here to try again!</a> --}}
            </div>
        </div>
    </div>
@endif
