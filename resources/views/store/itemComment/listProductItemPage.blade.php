...
@section("pageTitle", "LIST OF PRODUCTS AND COMMENTS")
...
@section('pageContent')
    ...
    @section('pageSubContent')
        @includeIf('store.itemComment.listProductItemPageView', ['showPageComment' => (isset($showPageComment) ? $showPageComment : 1)])
    @endsection
