...
@section("pageTitle")
Store Setting - {{ (isset($userStoreName)  ? $userStoreName : null) }}'s store
@endsection
...
@section('pageContent')
    ...
    @section('pageSubContent')
        @includeIf('store.storeSetting.viewStoreProfile.profilePageView', ['showPageProfile' => (isset($showPageProfile) ? $showPageProfile : 1)])
    @endsection
